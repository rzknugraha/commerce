<head>
    ...
    <link href="<?php echo base_url('asset/css/css/price-range.css')?>" rel="stylesheet">
    <link href="<?php echo base_url('asset/css/css/animate.css')?>" rel="stylesheet">
	<link href="<?php echo base_url('asset/css/css/main.css')?>" rel="stylesheet">
	<link href="<?php echo base_url('asset/css/css/responsive.css')?>" rel="stylesheet">
    <!--[if lt IE 9]>
